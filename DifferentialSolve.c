...
void Euler(float h,int n,float arr[n][4]);
void ModifiedEuler(float h,int n,float arr[n][4]);
void RungeKutta(float h,int n,float arr[n][4]);
void initializeArray(float x0,float y0,float f,int n,float arr[n][4]);
...
void initializeArray(float x0,float y0,float h,int n,float arr[n][4])
{
	int i;
	arr[0][0]=x0;
